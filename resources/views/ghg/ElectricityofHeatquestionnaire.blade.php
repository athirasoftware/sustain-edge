<div class="accordion cmnBx" id="dashBoarAccord1">

    <div id="dashBoarAccord2" class="accordion-collapse collapse show" aria-labelledby="headingTwo"
        data-bs-parent="#dashBoarAccord1">
        <div class="accordion-body ">
            <div class="stationaryBox" id="stationaryCombustionDiv">
                <div class="mainTitle">
                    1.Purchase of heat/steam/cold
                </div>
                <div>
                    {{-- <div class="addformdiv mt-4" id="formDiv" style="display:none;"> --}}
                    <div class="cmnBx addformdiv mt-4 formDivClass" id="formDiv" style="display:none">
                        <input type="hidden" name="particularId" id="particularId" value='1' />
                        <input type="hidden" name="stationaryParticular" id="stationaryParticular"
                            value='Purchase of heat/steam/cold' />
                        <div class="row cntr">
                            <div class="col-lg-4">
                                <div class="txtT" id="selectedFuelCategory">Selected Fuel:
                                    <span id="selectedFuelCategoryText" class="selectedFuelCategoryText">
                                        Biodiesel</span>
                                </div>
                                <span class="error" id="selectedFuelError"> </span>
                            </div>
                            <div class="col-lg-4">
                                <input name="fuelType" id="fuelType" class="form-control fuelType" hidden="hidden"
                                    value="Energy">
                                ...
                                <div class="itemBx">
                                    <div class="left">
                                        <div class="txtT"><b>Fuel:</b> <span
                                                id="editStationaryParticularText_{{ $randId }}">Electricity of
                                                Heat</span>
                                            <span id="">
                                    ...
                                    <div class="rtsertBxc" id="selectedView_{{ $randId }}">
                                        ...
                                        <div class="item">
                                            <button
                                                onclick="deletepurchaseCombustion('{{ Crypt::encrypt($existingStationaryParticular->id) }}');"
...
<script type="text/javascript">
    ...
    function saveFormPurchaseForm(randomNum) {
        ...
        var selectedFuel = "Purchase of heat/steam/cold";
        $('.selectedFuelCategoryText').html(selectedFuel);
                    ...
                    if (data.status == 'success') {
                        ...
                        setTimeout(() => {
                            ...
                            $('#stationaryCombustionDiv').load(
                                "{{ url('/getRefreshElectricityofHeat') }}");
                        }, 2000);
    ...
    function deletepurchaseCombustion(selectedFuelId) {
        ...
        $.ajax({
            url: "{{ url('/deleteElectricityofHeat') }}",
            method: 'post',
            dataType: "JSON",
            data: {
    ...
    function updatepurchaseFormCombustionForm(randomNum) {
        ...
        if (selectedFuel != '' && region != '' && unitOfMesurement != '' && quantityActual != '') {
            $.ajax({
                url: "{{ url('/updateElectricityofHeat') }}",
                method: 'post',
                dataType: "JSON",
                data: {
                    "randomNum": randomNum,
...
<script type="text/javascript">
    ...
    function editView(randomId, combustionId) {
        var url = "{{ URL::TO('editElectricityofHeat') }}";
