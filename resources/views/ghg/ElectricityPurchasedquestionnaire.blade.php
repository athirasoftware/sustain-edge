                ...
                <div>
                    ...
                    <div class="cmnBx addformdiv mt-4 formDivClass" id="formDiv" style="display:none">
                        ...
                        <input type="hidden" name="stationaryParticular" id="stationaryParticular"
                            value='Electricity purchased' />
                        <div class="row cntr">
                            <div class="col-lg-4">
                                <div class="txtT" id="selectedFuelCategory">Selected Fuel: <span
                                        id="selectedFuelCategoryText" class="selectedFuelCategoryText"> Biodiesel</span>
                                </div>
                                ...
                                <div class="itemBx">
                                    <div class="left">
                                        <div class="txtT"><b>Fuel:</b> <span
                                                id="editStationaryParticularText_{{ $randId }}">Electricity
                                                Purchased</span>
                                            <span id="">
...
<script type="text/javascript">
    ...
    function saveFormPurchaseForm(randomNum) {
        ...
        var selectedFuel = "Electricity Purchased";
        $('.selectedFuelCategoryText').html(selectedFuel);
        ...
        if (region != '' && unitOfMesurement != '' && quantityActual != '') {
            ...
            $.ajax({
                url: "{{ url('/saveElectricityPurchased') }}",
                method: 'post',
                dataType: "JSON",
                data: {
                    "randomNum": randomNum,
                    ...
                    if (data.status == 'success') {
                        ...
                        setTimeout(() => {
                            ...
                            $('#stationaryCombustionDiv').load(
                                "{{ url('/getRefreshElectricityPurchased') }}");
                        }, 2000);
    ...
    function deletepurchaseCombustion(selectedFuelId) {
        ...
        $.ajax({
            url: "{{ url('/deleteElectricityPurchased') }}",
            method: 'post',
            dataType: "JSON",
            data: {
    ...
    function updatepurchaseFormCombustionForm(randomNum) {
        ...
        if (selectedFuel != '' && region != '' && unitOfMesurement != '' && quantityActual != '') {
            $.ajax({
                url: "{{ url('/updateElectricityPurchased') }}",
                method: 'post',
                dataType: "JSON",
                data: {
                    "randomNum": randomNum,
...
<script type="text/javascript">
    ...
    function editView(randomId, combustionId) {
        var url = "{{ URL::TO('editElectricityPurchased') }}";
