                ...
                <div class="flx">
                    ...
                    <div class="rtsec">
                        <div class="topBox">
                            ...
                            <div id="ghgDiv"></div>
                            <div id="dashBoarAccord" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#dashBoarAccord">
                                <div class="accordion-body ">
                                        ...
                                        <div class="item-list" id="duplicateContent">
                                            ...
                                            <div class="item">
                                                <div class="itemBx">
                                                    <div class="left">
                                                        <div class="txtT">
                                                            <b>Purchased Item:</b> <span id="editStationaryParticularText_{{$randId}}">{{ $savedPurchasedItem['capital_goods_item'] }}</span>
                                                            <span class="px-2" id="editStationaryParticularText_{{$randId}}">({{ $savedPurchasedItem['cap_quantity'] }} {{$savedPurchasedItem['cap_uom']}})</span>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="cmnBx">
                                        <div class="mainTitle">3. Capital Goods</div>
                                        <form action="javascript:void(0)" id="purchase_good_service_form">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label for="">Purchased Goods *</label>
...
<script>
    $(document).ready(function() {
        ...
        $(".purchase_good_service_update, .purchase_good_service_save_update").on('click', function() {
            saveOrUpdate('updateCaptialGoods');
        });
        $(".purchase_good_service_save").on('click', function() {
            saveOrUpdate('saveCapitalGoods');
        });
        ...
        function saveOrUpdate(pathName) {
            ...
            if (pathName == 'saveCapitalGoods') {
                var urlPath = "{{ url('/saveCapitalGoods') }}";
                var purchase_good_service_item_Id = null;
            } else {
                var urlPath = "{{ url('/updateCaptialGoods') }}";
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data != '') {
                    ...
                    $(".mainTitle").text('3. Edit Capital Goods');
                    $(".purchase_good_service_item").val(data.result.capital_goods_item);
                    $(".supplier_vendor").val(data.result.cap_suplier_info);
                    //$(".supplier_vendor_gst").val(data.pur_suplier_gst);
                    $(".quantity").val(data.result.cap_quantity);
                    $(".uom").val(data.result.cap_uom);
