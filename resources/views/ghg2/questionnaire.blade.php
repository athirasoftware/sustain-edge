    ...
    <div class="accordion-item">
        ...
        <div id="dashBoarAccord1">
            <div class="accordion-body ">
                ...
                <div class=" mobileBox cmnBx" id="mobileCombustionDiv">
...
<script type="text/javascript">
    ...
    function saveFormCombustionForm(randomNum) {
        ...
        if(selectedFuel != '' && fuelType != '' && region != '' && unitOfMesurement != '' && quantityActual != '') {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.status == 'success') {
                        ...
                        setTimeout(() => {
                            $('.displayMsg').html('');
                            $('.displayMsg').hide();
                            $('#stationaryCombustionDiv').load("{{ url('/getRefreshStationaryCombution')}}");
                        }, 2000);
