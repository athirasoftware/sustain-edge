<div class="accordion" id="sideBarAccord">
    <div class="questnBx" id="quetionnaireSideBarDiv" style="display:none">
            ...
            <div id="sideBarAccord1" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#sideBarAccord">
                <div class="accordion-body">
                    <ul>
                        ...
                        <li>
                            <a href="javascript:void(0) " class="sideBtn scopeOne"  id="coneRefrigerants">3.Refrigerants</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="accordion-item">
            ...
            <div id="sideBarAccord2"
                class="accordion-collapse collapse  <?= basename($_SERVER["SCRIPT_FILENAME"], '.php') == 'purchaseElectricty' ? 'show' : '' ?>"
    ...
    <div class="reportBx" id="reportSideBarDiv" style="display:none">
        <div id="sideBarAccord1">
            <ul>
                <li>  <a href="reports"
                                class="<?= basename($_SERVER["SCRIPT_FILENAME"], '.php') == 'reports' ? 'active' : '' ?>">Reports</a> </li>
                 </ul>
        </div>
    </div>
