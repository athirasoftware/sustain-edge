...
<div class="item-list" id="duplicateContent">
    ...
    <div class="item">
        <div class="itemBx">
            <div class="left">
                <div class="txtT">Selected Fuel: <span id="editStationaryParticularText_{{$randId}}">{{$existingStationaryParticular}}</span>
                </div>
            </div>
            <div class="rtsertBxc" id="selectedView_{{$randId}}">
                <div class="item">
                    <button onclick="editView('{{$randId}}', '{{Crypt::encrypt($key)}}');" class="cmnbtn hoveranim"><span>Edit</span></button>
                </div>
                <div class="item">
                    <button onclick="deleteStationaryCombustion('{{Crypt::encrypt($key)}}');" class="cmnbtn hoveranim"><span>Remove</span></button>
                </div>
            </div>
